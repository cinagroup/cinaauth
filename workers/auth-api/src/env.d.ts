...
export interface CloudflareBindings extends Cloudflare.Env {
	...
	/** Dedicated queue for CinaToken organization identity projections. */
	CINATOKEN_IDENTITY_EVENTS_QUEUE: Queue<OrganizationIdentityEvent>;
	/** Private service binding to the CinaToken Admin Worker event receiver. */
	CINATOKEN_IDENTITY_EVENTS_SERVICE: Fetcher;
	/** Canonical HTTPS fallback endpoint for organization identity events. */
	CINATOKEN_IDENTITY_EVENTS_URL?: string;
	/** Independent HMAC secret for CinaAuth -> CinaToken identity events. */
