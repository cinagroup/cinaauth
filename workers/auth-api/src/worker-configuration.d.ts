/* eslint-disable */
// Generated by Wrangler by running `wrangler types --include-runtime=false --env-interface=CloudflareBindings ./src/worker-configuration.d.ts` (hash: e2c2c13678b791db090b1b537a8abe1e)
interface __BaseEnv_CloudflareBindings {
	...
	CINATOKEN_IDENTITY_EVENTS_QUEUE: Queue;
	...
	CINATOKEN_IDENTITY_EVENTS_SECRET_STORE_V2: SecretsStoreSecret;
	...
	CINATOKEN_IDENTITY_EVENTS_URL: "https://cinatoken.com/api/integrations/cinaauth/organization-events";
