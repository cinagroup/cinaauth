...
const makeEnv = (
	...
	({
		...
		CINATOKEN_OIDC_CLIENT_SECRET: `${ADMIN_OIDC_CLIENT_SECRET_PREFIX}${strong("cinatoken-client")}`,
		CINATOKEN_OIDC_BRIDGE_SECRET: strong("cinatoken-bridge"),
		...
		expect(
			getRuntimeConfigIssues(
				makeEnv({
					...
					CINATOKEN_OIDC_CLIENT_SECRET: "short",
