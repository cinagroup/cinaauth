/**
 * Error classes for the cinaauth SDK
 */
...
export class CinaauthError extends Error {
  ...
  constructor(message: string, code: string = 'UNKNOWN_ERROR', details?: any, statusCode?: number) {
    ...
    if ('captureStackTrace' in Error) {
      (Error as any).captureStackTrace(this, CinaauthError);
    }
  }
}

export class ValidationError extends CinaauthError {
...
export class AuthenticationError extends CinaauthError {
...
export class AuthorizationError extends CinaauthError {
...
export class NotFoundError extends CinaauthError {
...
export class ConflictError extends CinaauthError {
...
export class RateLimitError extends CinaauthError {
...
export class ServerError extends CinaauthError {
...
export class NetworkError extends CinaauthError {
...
export class TimeoutError extends CinaauthError {
...
export function createErrorFromResponse(
  ...
  switch (statusCode) {
    ...
    default:
      return new CinaauthError(message, code, details, statusCode);
  }
}

/**
 * Type guard to check if an error is an CinaauthError
 */
export function isCinaauthError(error: any): error is CinaauthError {
  return error instanceof CinaauthError;
}
...
export function isRetryableError(error: any): boolean {
  ...
  if (isCinaauthError(error) && error.statusCode) {
