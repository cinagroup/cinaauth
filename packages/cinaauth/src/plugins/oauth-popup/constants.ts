...
export const OAUTH_POPUP_MESSAGE_TYPE = "cinaauth:oauth-popup";

/** DOM id of the inert JSON data block the completion page reads. */
export const OAUTH_POPUP_DATA_ELEMENT_ID = "cinaauth-oauth-popup";
...
export const POPUP_TOKEN_STORAGE_KEY = "cinaauth.popup_token";
