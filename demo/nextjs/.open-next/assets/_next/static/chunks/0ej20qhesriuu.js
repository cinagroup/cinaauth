(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
	...
	(e) => {
		"use strict";
		const s = (0, e.i(10283).default)("loader-circle", [
			["path", { d: "M21 12a9 9 0 1 1-6.219-8.56", key: "13zald" }],
		]);
		e.s(["Loader2", 0, s], 69016);
	},
	1359,
	(e) => {
		"use strict";
	...
	(e) => {
		...
		function w({ token: e, onSuccess: r }) {
			const [n, x] = (0, i.useTransition)(),
				f = (0, d.useForm)({
			...
			[
				...
				function () {
					...
					return (0, s.jsx)("div", {
						...
						children: (0, s.jsxs)(x.Card, {
							className: "w-[350px]",
							children: [
								(0, s.jsxs)(x.CardHeader, {
									children: [
										(0, s.jsx)(x.CardTitle, { children: "Reset password" }),
										(0, s.jsx)(x.CardDescription, {
											children:
												"Enter new password and confirm it to reset your password",
										}),
									],
								}),
								(0, s.jsx)(x.CardContent, {
									children: (0, s.jsx)(w, {
										token: a,
