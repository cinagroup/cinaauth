(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
				...
				ee(e, t, r ? u[g]() : u, {
					...
					close: function (t) {
						if (!a)
							for (
								a = !0,
									l === n.length ? (n[l] = N(e, t, !0)) : I(e, n[l], t, !0),
									l++;
								l < n.length;
							)
								I(e, n[l++], '"$undefined"', !0);
					...
					error: function (t) {
						if (!a)
							for (a = !0, l === n.length && (n[l] = b()); l < n.length; )
								C(e, n[l++], t);
					},
				});
		}
								...
								if ("$" === n[0]) {
									...
									switch (n[1]) {
										...
										case "T":
											...
											return e.get(t);
										case "Q":
											return $(e, (n = n.slice(2)), t, r, K);
										case "W":
											return $(e, (n = n.slice(2)), t, r, G);
										case "B":
											return $(e, (n = n.slice(2)), t, r, q);
										case "K":
											return $(e, (n = n.slice(2)), t, r, Y);
										case "Z":
											return ea();
										case "i":
											return $(e, (n = n.slice(2)), t, r, z);
										case "I":
											return 1 / 0;
										case "-":
											return "$-0" === n ? -0 : -1 / 0;
		...
		function es(e, t, r) {
			...
			u.read()
				.then(function t(i) {
					...
					i = l._rowID;
					for (
						var h = l._rowTag, p = l._rowLength, y = l._buffer, g = o.length;
						c < g;
					) {
						var _ = -1;
						switch (f) {
												...
												case 73:
													...
													if ((h = s(g))) {
														if (y) {
															...
															(_ = new P("blocked", null, null)), p.set(f, _);
														h.then(
															function () {
																return j(c, _, g);
															},
											...
											s.read(new Uint8Array(1024)).then(function e(t) {
												t.done
													? ((t = i++),
														...
														0 == --o && r(f))
													: (h.push(t.value),
														s.read(new Uint8Array(1024)).then(e, n));
											}, n),
											"$r" + d.toString(16)
										);
									})(d);
	...
	(e, t, r) => {
		...
		const l = e.r(66913),
			...
			i = e.r(7321);
		function o(e) {
			const t = e.headers.get(i.NEXT_REWRITTEN_QUERY_HEADER);
		...
		function f(e, t, r) {
			switch (e) {
				...
				case "ci(...)": {
					const n = e.length - 2;
					return r < t.length
						? t.slice(r).map((e, t) => (0 === t ? s(e.slice(n)) : s(e)))
						: [];
				}
				case "oc":
						...
						JSON.stringify(
							(function e(t) {
								const [r, n, a, u, i] = t,
									...
									c = {};
								for (const [t, r] of Object.entries(n)) c[t] = e(r);
								const s = [o, c];
								return (
									u && ((s[2] = null), (s[3] = u)),
									void 0 !== i && (s[4] = i),
	...
	(e, t, r) => {
		...
		function c(e, t, r, n, a) {
			const o = (function e(t, r, n, a, l, o) {
				let c, f;
	...
	(e, t, r) => {
			...
			(e.isCanceled = !0),
				(function (e, t) {
					...
					if (-1 !== r && ((t._heapIndex = -1), 0 !== e.length)) {
						const n = e.pop();
						n !== t && ((e[r] = n), (n._heapIndex = r), $(e, n, r));
					}
				})(h, e);
		}
		function P(e, t, r, n) {
									...
									case i.EntryStatus.Fulfilled: {
										...
										switch (
												...
												if (
													...
													0 ===
														(function e(t, r, n, a, u) {
															const o = (0, i.readOrCreateSegmentCacheEntry)(
																t,
																r.fetchStrategy,
																u,
															);
																	...
																	if (
																		...
																		(void 0 !== d && L(n, o, d)
																			...
																			: (function e(t, r, n, a) {
																					if (
																						a.prefetchHints &
																						l.PrefetchHint.HasRuntimePrefetch
																					)
																						return (
																							null ===
													...
													return 0;
												const o = t.spawnedRuntimePrefetches;
												if (null !== o) {
													const n = new Map();
											...
											case c.FetchStrategy.LoadingBoundary: {
												const n = new Map();
												M(e, t, r, n, o);
												const a = (function e(t, r, n, a, u, o, s) {
													const f = a[1],
														d = u.slots,
														h = {};
													if (null !== d)
							...
							switch (l.status) {
								case i.EntryStatus.Empty:
									I(t) &&
										...
										w((0, i.fetchRouteOnCacheMiss)(l, a)));
								case i.EntryStatus.Pending:
								case i.EntryStatus.Fulfilled:
								case i.EntryStatus.Rejected:
							}
		...
		function j(e, t, r, n, a, l, u) {
			...
			switch (o.status) {
				...
				case i.EntryStatus.Fulfilled:
					if (
						o.isPartial &&
						(0, i.canNewFetchStrategyProvideMoreContent)(o.fetchStrategy, u)
					) {
						if (
							u === c.FetchStrategy.Full &&
			...
			const f = {};
			if (null !== n.slots)
				for (const i in n.slots) {
					const o = n.slots[i];
					f[i] = j(e, t, r, o, a || null !== s, l, u);
				}
			null !== s && l.set(n.requestKey, s);
			const d = a || null === s ? null : "refetch";
		...
		function F(e, t, r, n) {
			const a = (0, i.readOrCreateRevalidatingSegmentEntry)(
				e,
				c.FetchStrategy.PPR,
				n,
			);
		...
		function U(e, t, r) {
			const n = (0, i.readOrCreateRevalidatingSegmentEntry)(e, r, t);
			...
			if ((0, i.canNewFetchStrategyProvideMoreContent)(n.fetchStrategy, r)) {
				const n = (0, i.overwriteRevalidatingSegmentCacheEntry)(e, r, t);
				return (0, i.upgradeToPendingSegment)(n, r);
			}
			switch (n.status) {
				case i.EntryStatus.Pending:
		...
		function V(e) {
			...
			t._heapIndex = -1;
			const r = e.pop();
			return r !== t && ((e[0] = r), (r._heapIndex = 0), $(e, r, 0)), t;
		}
		function B(e, t) {
			const r = t._heapIndex;
			-1 !== r &&
		...
		function g(e, t) {
			...
			if (
				...
				return {
					id: null,
					value: r.value,
					parent: { id: "?", value: u.Fallback, parent: e },
				};
			}
			return r;
		}
	...
	(e, t, r) => {
		...
		const y = "function" == typeof WeakMap ? new WeakMap() : new Map(),
			g = new Set(),
			_ =
		...
		function R(t) {
			...
			{
				const { createPrefetchURL: r } = e.r(42328);
				try {
					return r(t);
				} catch {
					return (
		...
		function T(t, r) {
			if ("u" > typeof window) {
				...
				const { getCurrentAppRouterState: a } = e.r(21241),
					l = a();
				if (null !== l) {
					const e = l.tree;
					if (null === n) {
	...
	(e, t, r) => {
		...
		function p(e, t) {
			if ("u" < typeof window) return;
			const r = (0, u.getFromCacheMap)(-1, s, c, e, !1);
			null !== r && (r.staleAt = t);
		}
		function y(e) {
			return "u" < typeof window
				? null
				: (0, u.getFromCacheMap)(-1, s, c, e, !1);
		}
		function g(e, t) {
			return "u" < typeof window
				? null
				: (0, u.getFromCacheMap)(e, s, c, t, !1);
		}
		("function" == typeof r.default ||
			("object" == typeof r.default && null !== r.default)) &&
			void 0 === r.default.__esModule &&
	...
	(e, t, r) => {
		...
		function s(e, t, r, n, a, u, i, o, s, d) {
			const h = t.split("/").filter((e) => "" !== e),
				p = h.length > 0 ? h[0] : null,
				y = h.length > 0 ? h.slice(1) : [];
			if (null !== n) {
				const h = (0, l.fulfillRouteCacheEntry)(e, n, a, u, i, o, s);
				return (
		...
		function f(e, t, r, n, a, i, c, s, d, h, p, y, g, _) {
			let v,
				...
				S = null;
			"string" == typeof E
				? (v = (0, u.doesStaticSegmentAppearInURL)(E))
				: ((m = E[0]), (P = E[2]), (S = E[3]), (v = !0));
			let b = e,
				T = r,
				O = n;
			if (v) {
				if (null === m && r !== E)
					return null !== a
						? a
						: (0, l.writeRouteIntoCache)(i, c, s, d, h, p, y, g);
				if (null !== m && null !== P) {
					if (
						((b = (function (e, t, r) {
						...
						for (const t of (null === e.staticChildren &&
			...
			if (null !== w) {
				for (const e in w) {
					const t = w[e];
					null === t.refreshState &&
						(A = f(b, t, T, O, a, i, c, s, d, h, p, y, g, _));
				}
				return null !== A
					? A
					: null !== a
		...
		function d(e, t) {
			const r = e.split("/").filter((e) => "" !== e),
				...
				a = (function e(t, r, n, a) {
					...
					if (null !== l) {
						const u = t.staticChildren.get(l);
						if (void 0 !== u) {
							if (
								null === u.pattern &&
								null === u.dynamicChild &&
								null === u.staticChildren
							)
								return null;
							const t = e(u, r, n + 1, a);
				...
				f = (function e(t, r, n, a, l) {
					...
					if ("string" != typeof o) {
						const e = o[0],
							...
							l = r.get(e);
						if (void 0 !== l) {
							const r = Array.isArray(l) ? l.join("/") : l;
							(c = [e, r, t, n]), (u = (0, i.appendLayoutVaryPath)(a, r, e));
						} else u = a;
					} else u = a;
					let s = null;
					if (null !== t.slots)
						for (const a in ((s = {}), t.slots))
							s[a] = e(t.slots[a], r, n, u, l);
					if (t.isPage) {
						const e = (0, i.finalizePageVaryPath)(t.requestKey, n, u);
						return (
							null === l.metadataVaryPath &&
								(l.metadataVaryPath = (0, i.finalizeMetadataVaryPath)(
									t.requestKey,
									n,
									u,
								)),
					...
					{
						const e = (0, i.finalizeLayoutVaryPath)(t.requestKey, u);
						return {
							requestKey: t.requestKey,
							segment: c,
							refreshState: t.refreshState,
			...
			if (null === d) return null;
			const h = (0, l.createMetadataRouteTree)(d),
				p = {
					canonicalUrl: e + t,
	...
	(e, t, r) => {
		...
		function L(e, t) {
			j++, D++, (0, v.pingVisibleLinks)(e, t), H(e, t);
		}
		function k(e, t) {
			j++, (0, v.pingVisibleLinks)(e, t), H(e, t);
		}
		function x(e, t) {
		...
		function V(e, t) {
			const r = (0, s.getRouteVaryPath)(t.pathname, t.search, t.nextUrl),
				n = (0, p.getFromCacheMap)(e, j, N, r, !1);
		...
		function G(e, t, r) {
			...
			const a = new URL(t);
			a.search = "";
			const l = V(e, (0, d.createCacheKey)(a.href, r));
		...
		function Y(e, t, r) {
			const n = B(e, r.varyPath);
			if (null !== n) return n;
			const a = (0, s.getSegmentVaryPathForRequest)(t, r),
				l = J(e);
			return (0, p.setInCacheMap)(I, a, l, !1), l;
		}
		function z(e, t, r) {
			var n;
			const a = ((n = r.varyPath), (0, p.getFromCacheMap)(e, D, I, n, !0));
			if (null !== a) return a;
			const l = (0, s.getSegmentVaryPathForRequest)(t, r),
				u = J(e);
			return (0, p.setInCacheMap)(I, l, u, !0), u;
		}
		function W(e, t, r) {
			const n = (0, s.getSegmentVaryPathForRequest)(t, r),
				a = J(e);
		...
		function ee(e, t, r) {
			...
			if (null !== a) {
				const r = a.navigatedAt + _.STATIC_STALETIME_MS;
		...
		function et(e, t) {
			...
			if (null !== n) {
				const r = n.navigatedAt + _.STATIC_STALETIME_MS;
				if (e > r) return null;
				const a = ei(Z(J(e), E.FetchStrategy.Full), n.rsc, r, !1),
					l = Q(
						e,
						(0, s.getSegmentVaryPathForRequest)(E.FetchStrategy.Full, t),
						a,
					);
		...
		function er(e) {
			...
			if (null !== t) {
				for (const e of t) (0, c.pingPrefetchTask)(e);
				e.blockedTasks = null;
			}
		}
		function en(e) {
		...
		function ea(e, t, r, n, a, l, u) {
			const i = (0, s.getRenderedSearchFromVaryPath)(n) ?? "";
			return (
				(t.status = 2),
				(t.tree = r),
				(t.metadata = en(n)),
		...
		async function eh(e, t) {
			...
			try {
				...
				const _ = (0, f.createHrefFromUrl)(c),
				...
				if (C) {
					let n,
						u,
						{ stream: i, size: c } = await em(t.body);
					A.resolve(), (0, p.setSizeInCacheMap)(e, c);
					const f = await (0, o.createFromNextReadableStream)(i, l, {
					...
					if (
						...
						return eo(e, Date.now() + 1e4), null;
					const d = (0, h.getRenderedPathname)(t),
								...
								if (null !== p)
									...
									p)) {
										let r,
											...
											v = g.param;
										if (null !== v) {
											const e = (0, h.parseDynamicParamFromURLPart)(
													v.type,
													l,
													u,
												),
										...
										const R = r ? u + 1 : u,
											E = (0, y.createSegmentRequestKeyPart)(c),
											m = (0, y.appendSegmentRequestKeyPart)(a, t, E);
									...
									a.endsWith(R.PAGE_SEGMENT_KEY)
										? ((c = !0),
											...
											null === o.metadataVaryPath &&
												(o.metadataVaryPath = (0, s.finalizeMetadataVaryPath)(
													a,
													i,
													n,
												)))
						...
						m = v.metadataVaryPath;
					if (null === m) return eo(e, Date.now() + 1e4), null;
					(0, S.discoverKnownRoute)(Date.now(), r, a, e, E, m, w, _, C, !1);
				} else {
					const { stream: n, size: c } = await em(t.body);
					A.resolve(), (0, p.setSizeInCacheMap)(e, c);
					const s = await (0, o.createFromNextReadableStream)(n, l, {
						allowPartialStream: !0,
					});
					if (
					...
					!(function (e, t, r, n, a, l, u, o, c, s, f) {
						const d = (0, h.getRenderedSearch)(r),
						...
						(0, S.discoverKnownRoute)(e, s, f, a, E, m, l, u, o, !1);
						const T = (0, b.convertServerPatchToFullTree)(
							e,
							_,
							p,
							d,
							P.UnknownDynamicStaleTime,
						);
						ev(
							e,
							t,
						...
						Date.now(),
						E.FetchStrategy.LoadingBoundary,
						t,
						s,
						e,
						w,
				...
				if (!w) {
					const t = (0, s.getFulfilledRouteVaryPath)(r, n, a, w);
		...
		async function ep(e, t, r, n) {
			...
			try {
				...
				const r = (0, m.createPromiseWithResolvers)(),
					{ stream: l, size: u } = await em(e.body);
				r.resolve(), (0, p.setSizeInCacheMap)(t, u);
				const c = await (0, o.createFromNextReadableStream)(l, f, {
					allowPartialStream: !0,
				});
				if (
				...
				c.varyParams;
				const g = (0, s.getSegmentVaryPathForRequest)(t.fetchStrategy, n);
		...
		async function ey(e, t, r, n) {
			...
			try {
				...
				const l = (0, m.createPromiseWithResolvers)(),
					{ stream: c } = await em(t.body);
				l.resolve();
				const s = await (0, o.createFromNextReadableStream)(c, u, {
					allowPartialStream: !0,
				});
				if (
					(t.headers.get(O.NEXT_NAV_DEPLOYMENT_ID_HEADER) ??
						s.tree.segment.buildId) !== (0, T.getNavigationBuildId)()
				)
					return e_(n, Date.now() + 1e4), null;
				const f = Date.now();
				!(function e(t, r, n, a, l) {
					...
					if (void 0 !== o) ei(o, u.rsc, i, u.isPartial);
						...
						const e = Y(t, E.FetchStrategy.PPR, n);
						0 === e.status &&
							ei(Z(e, E.FetchStrategy.PPR), u.rsc, i, u.isPartial);
					}
					if (null !== n.slots && null !== a.slots)
						for (const u in n.slots) {
							const i = n.slots[u],
								o = a.slots[u];
							void 0 !== o && e(t, r, i, o, l);
						}
				})(f, e, r, s.tree, n);
				const d = f + w(s.head.staleTime),
					h = e.metadata.requestKey,
					p = n.get(h);
				if (void 0 !== p) ei(p, s.head.rsc, d, s.head.isPartial);
				else {
					const t = Y(f, E.FetchStrategy.PPR, e.metadata);
					0 === t.status &&
						ei(Z(t, E.FetchStrategy.PPR), s.head.rsc, d, s.head.isPartial);
				}
		...
		async function eg(e, t, r, n, a) {
			...
			try {
				...
				const i = (0, h.getRenderedSearch)(l);
				...
				if (r === E.FetchStrategy.Full) {
					...
					(d = l.body),
						...
						(_ = function (e) {
							if (null === v) return;
							const t = e / v.length;
							for (const e of v) (0, p.setSizeInCacheMap)(e, t);
						}),
						(t = 0),
						(r = d.getReader()),
					...
					const { stream: t, size: r } = await em(l.body);
					s.resolve(), (e = t), (R = r);
				}
				const [S, T] = await Promise.all([
					...
					C = Date.now(),
					N = await eT(C, S.s, l),
					I = r === E.FetchStrategy.PPRRuntime && (T?.isResponsePartial ?? !1),
					M = l.headers.get(O.NEXT_NAV_DEPLOYMENT_ID_HEADER) ?? S.b,
					j = (0, g.normalizeFlightData)(S.f);
				if ("string" == typeof j) return e_(a, Date.now() + 1e4), null;
				const D = (0, b.convertServerPatchToFullTree)(
					C,
					n,
					j,
					i,
				...
				if (
					((v = ev(C, r, j, M, I, A, N, D, a)),
					null !== R && null !== v && v.length > 0)
				) {
					const e = R / v.length;
					for (const t of v) (0, p.setSizeInCacheMap)(t, e);
				}
				...
				if (null !== r) {
					...
					!(function e(t, r, n, a, l, i, o) {
						...
						eR(
							...
							null === c || i,
							a,
							null !== s ? (0, u.readVaryParams)(s) : null,
							n,
							o,
						);
						const f = n.slots;
		...
		function eR(e, t, r, n, a, l, u, i) {
			const o = null !== i ? i.get(u.requestKey) : void 0;
			if (void 0 !== o) ei(o, r, a, n);
			else {
				const l = Y(e, t, u);
				if (0 === l.status) ei(Z(l, t), r, a, n);
				else {
					const l = ei(Z(J(e), t), r, a, n);
					Q(e, (0, s.getSegmentVaryPathForRequest)(t, u), l);
				}
			}
		}
		async function eE(e, t) {
			const r = await (0, o.createFetch)(e, t, "low", !1);
			if (!r.ok) return null;
			{
		...
		async function em(e) {
			...
			if (1 === n.length) t = n[0];
				...
				t = new Uint8Array(a);
				let e = 0;
				for (const r of n) t.set(r, e), (e += r.byteLength);
		...
		function eO(e, t, r, n, a, l, i, o) {
			const c = o ? E.FetchStrategy.PPR : E.FetchStrategy.Full,
		...
		async function ew(e, t, r, n) {
			const { stream: a, isPartial: l } = await eA(t),
			...
			const h = (0, b.convertServerPatchToFullTree)(
				e,
				r,
				d,
				n,
	...
	(e, t, r) => {
		...
		async function m(e, t) {
			...
			try {
				...
				const [f, h] = await Promise.all([c, t.cacheData]);
				if (
					(t.headers.get(y.NEXT_NAV_DEPLOYMENT_ID_HEADER) ?? f.b) !==
					(0, p.getNavigationBuildId)()
				)
					return R(t.url);
				const _ = (0, s.normalizeFlightData)(f.f);
				if ("string" == typeof _) return R(_);
				const v = null !== h ? await S(h, f, a) : null;
				return {
					flightData: _,
					canonicalUrl: n,
					renderedSearch: f.q,
		...
		async function S(e, t, r) {
			const { isResponsePartial: n, responseBodyClone: a } = e;
			if (a) {
				if (!n) return a.cancel(), { response: t, isResponsePartial: !1 };
				if (void 0 !== t.l)
					return { response: await b(a, t.l, r), isResponsePartial: !0 };
				a.cancel();
			}
			return null;
		}
		...
		async function T(e, t, r, a, l) {
			...
			const y = fetch(p, {
				...
				m = new URL(R.url, p);
			return (
				m.searchParams.delete(i.NEXT_RSC_UNION_QUERY),
				{
					url: m.href,
					redirected: E,
					ok: R.ok,
			...
			Object.defineProperty(r, "isNavigatingToNewRootLayout", {
				...
				get: function () {
					return function e(t, r) {
						...
						const u = ((t[4] ?? 0) & n.PrefetchHint.IsRootLayout) != 0,
	...
	(e, t, r) => {
		...
		function T(e, t, r, n, a, l, s, f, d, p, y, _, v) {
			...
			return (function e(t, r, n, a, l, c, s, f, d, p, y, _, v, R, E, m) {
				var P, S, b;
				let T,
					A,
					M,
				...
				const V = null === U;
				if (void 0 === n || H || (V && _)) {
					const e = N(t, l, null !== d ? d[0] : null, c, p, s, y);
					(M = e.cacheNode),
						(j = e.needsDynamicRequest),
				...
				const B = l.refreshState,
					X = null != B ? B : E;
				j &&
					null !== X &&
					((b = m),
					(T = X.canonicalUrl),
					null === (A = b.separateRefreshUrls)
						? (b.separateRefreshUrls = new Set([T]))
						: A.add(T));
				let $ = {},
					K = null,
					G = !1,
					...
					Y = null;
				if (null !== U) {
					const a = void 0 !== n ? n.slots : null;
					for (const n in ((M.slots = Y = {}), (K = new Map()), U)) {
						let u = U[n],
							o = L[n];
						...
						2 !== s &&
							...
							((h = w(
								(u = (function (e, t, r, n) {
									...
									const i = (0, g.convertReusedFlightRouterStateToRouteTree)(
										e,
										t,
										n,
										l,
									...
									return (
										(i.refreshState = { canonicalUrl: a, renderedSearch: l }), i
									);
								})(l, n, R, o)),
							)),
							(f = null),
				...
				return {
					...
					route: z,
					node: M,
					dynamicRequestTree: C(z, q, j, G, v),
					refreshState: X,
					children: K,
				};
			})(
		...
		function O(e, t, r, n, a, l, u, i, o) {
			...
			let y = {},
				...
				R = null;
			if (null !== s)
				for (const t in ((h.slots = R = {}), (g = new Map()), s)) {
					const a = O(
						e,
						s[t],
						r,
					...
					const c = a.route;
					y[t] = c;
					const d = a.dynamicRequestTree;
					null !== d ? ((_ = !0), (v[t] = d)) : (v[t] = c);
				}
			const E = [c, y, null, null, t.prefetchHints];
			return {
				status: +!p,
				route: E,
				node: h,
				dynamicRequestTree: C(E, v, p, _, i),
				refreshState: null,
				children: g,
			};
		}
		function w(e) {
			if (e.isPage) {
				const t = (0, E.getRenderedSearchFromVaryPath)(e.varyPath);
				if (null === t) return i.PAGE_SEGMENT_KEY;
				const r = JSON.stringify(Object.fromEntries(new URLSearchParams(t)));
		...
		function C(e, t, r, n, a) {
			let l = null;
			return (
				r ? ((l = A(e, t)), a || (l[3] = "refetch")) : (l = n ? A(e, t) : null),
				l
			);
		}
		function N(e, t, r, n, a, l, u) {
			...
			switch (l) {
				case 0: {
					const r = (0, m.readFromBFCacheDuringRegularNavigation)(
						e,
						t.varyPath,
					);
					if (null !== r)
			...
			if (s) {
				let t = null,
					r = !0;
				if (null !== n) {
					const a = (0, g.readSegmentCacheEntry)(e, n);
					if (null !== a)
						switch (a.status) {
							case g.EntryStatus.Fulfilled:
			...
			return (
				5 !== l &&
					((0, m.writeToBFCache)(e, t.varyPath, o, i, _, y, u),
					s && null !== n && (0, m.writeHeadToBFCache)(e, n, _, y, u)),
		...
		function j(e, t, r, n, a, l, u) {
			...
			if (null !== s) {
				f = [];
				const a = (0, c.createHrefFromUrl)(t);
				for (const t of s)
					t !== a &&
						null !== i &&
						f.push(U(e, i, new URL(t, location.origin), r, n, l));
			}
					...
					(o = (function e(t, r, n) {
						...
						0 === t.status
							? ((t.status = 2),
								...
								(u = n),
								k((o = a.rsc)) &&
									(null === l ? o.resolve(null, u) : o.reject(l, u)),
		...
		function F(e, t, r, n, a, l, u) {
			...
			const i = (0, p.getLastCommittedTree)(),
		...
		async function U(e, t, r, n, a, l) {
			try {
				const u = await (0, s.fetchServerResponse)(r, {
					flightRouterState: t,
					nextUrl: n,
					isHmrRefresh: 4 === a,
				});
				...
				if (null !== l && null !== u.staticStageData) {
					const { response: e, isResponsePartial: r } = u.staticStageData;
					(0, g.getStaleAt)(i, e.s)
						.then((n) => {
							const a =
								u.responseHeaders.get(R.NEXT_NAV_DEPLOYMENT_ID_HEADER) ?? e.b;
				...
				null !== l &&
					...
					(0, g.processRuntimePrefetchStream)(
						...
						.catch(() => {});
				const f = (0, m.computeDynamicStaleAt)(i, u.dynamicStaleTime);
				return {
					exitStatus: +!!(function e(t, r, n, a, l, u) {
						0 === t.status &&
							...
							(0, m.updateBFCacheEntryStaleAt)(r.varyPath, l));
						let i = t.children,
							c = r.slots,
							s = null !== n ? n[1] : null,
							f = !1;
	...
	(e, t, r) => {
		...
		function s(e) {
			return (
				e.reduce(
					(e, t) =>
						"" === (t = o(t)) || (0, u.isGroupSegment)(t) ? e : `${e}/${t}`,
					"",
				) || "/"
			);
		}
			...
			const r = (function e(t, r) {
				...
				if (
					l.INTERCEPTION_ROUTE_MARKERS.some(
						(e) => s.startsWith(e) || d.startsWith(e),
					)
				)
					return "";
	...
	(e, t, r) => {
		...
		function _(e, t, r, n, a, l, u, i, o, s) {
			return (function (e, t, r, n, a, l, u, i, o, s) {
				...
				if (null === y || y.status !== c.EntryStatus.Rejected) {
					const f = (0, c.deprecated_requestOptimisticRouteCacheEntry)(d, t, u);
		...
		function v(e, t, r, n, a, l, i, o, c, s, f, d, h, p, y) {
			const g = { separateRefreshUrls: null, scrollRef: null },
				_ = r.href === l.href,
			...
			return null !== v
				? (s !== u.FreshnessPolicy.Gesture &&
						(0, u.spawnDynamicRequests)(v, r, f, s, g, y, h),
					S(
						t,
						r,
						f,
		...
		async function m(e, t, r, n, a, f, h, p, y, g, _) {
			...
			const m = (0, l.fetchServerResponse)(r, {
					flightRouterState: R,
					nextUrl: f,
				}),
				S = await m;
			...
			if (null !== U) {
				if (
					...
					const { response: t, isResponsePartial: r } = I;
					(0, c.getStaleAt)(e, t.s)
						.then((n) => {
							const a = j.get(o.NEXT_NAV_DEPLOYMENT_ID_HEADER) ?? t.b;
							(0, c.writeStaticStageResponseIntoCache)(
								e,
								t.f,
								a,
								t.h,
				...
				null !== M &&
					(0, c.processRuntimePrefetchStream)(e, M, p, w)
						.then((t) => {
							null !== t &&
		...
		function S(e, t, r, n, a, l, u, i, o, c, s) {
			...
			if (o === h.ScrollBehavior.NoScroll)
				...
				const t = e.focusAndScrollRef.scrollRef;
				null !== t && (t.current = !1),
					null !== c && (c.current = !1),
					(f = { current: !0 }),
					(d = !0);
		...
		function T(e, t, r, n, a) {
			let l = t,
				...
				i = null;
			if (null !== r)
				for (const { segmentPath: e, tree: t, seedData: a, head: o } of r) {
					const r = (function e(t, r, n, a, l, u, i) {
						let o;
	...
	(e, t, r) => {
		...
		function s(e, t) {
			...
			const o = new URL(e.canonicalUrl, location.origin),
				c = e.renderedSearch;
			return (0, l.navigate)(
				e,
				r,
	...
	(e, t, r) => {
		...
		function o(e, t) {
			...
			if (t.previousTree !== e.tree)
				return (0, u.refreshReducer)(e, { type: a.ACTION_REFRESH });
			const h = (0, n.createHrefFromUrl)(o),
				p = t.nextUrl,
	...
	(e, t, r) => {
		...
		function i(e, t) {
			...
			const c = new URL(e.canonicalUrl, location.origin),
				s = t.url,
	...
	(e, t, r) => {
		...
		async function I(e, t, { actionId: r, actionArgs: c }) {
			let f,
				...
				R = (0, _.omitUnusedArgs)(c, v),
				S = await (0, o.encodeReply)(R, { temporaryReferences: g }),
				b = {
			...
			const w = await fetch(e.canonicalUrl, {
				method: "POST",
				headers: b,
				body: S,
			});
...
Read more: https://nextjs.org/docs/messages/failed-to-find-server-action`),
			...
			const C = w.headers.get("x-action-redirect"),
				[M, j] = C?.split(";") || [];
			switch (j) {
				case "push":
					f = "push";
			...
			try {
				const e = w.headers.get("x-action-revalidated");
				if (e) {
			...
			if (k) {
				...
				const r = w.headers.get(P.NEXT_NAV_DEPLOYMENT_ID_HEADER) ?? t.b;
				if (void 0 !== r && r !== (0, m.getNavigationBuildId)());
				else {
					const e = (0, h.normalizeFlightData)(t.f);
					"" !== e && ((p = e), (y = t.q));
				}
			...
			return I(e, a, t).then(
				async ({
					...
					l !== T.ActionDidNotRevalidate &&
						...
						(0, R.startRevalidationCooldown)());
					const _ = d || "push";
					if (void 0 !== s)
						if ((0, O.isExternalURL)(s))
							return n(j(s.href, _)), (0, S.completeHardNavigation)(e, s, _);
						else {
							const e = (0, f.createHrefFromUrl)(s, !1);
							n(j((0, g.hasBasePath)(e) ? (0, y.removeBasePath)(e) : e, _));
						}
					else r(u);
					if (void 0 === s && l === T.ActionDidNotRevalidate && void 0 === i)
						return e;
					if (void 0 === i && void 0 !== s)
						return (0, S.completeHardNavigation)(e, s, _);
					if ("string" == typeof i)
					...
					const E = new URL(e.canonicalUrl, location.origin),
						m = e.renderedSearch,
						P = void 0 !== s ? s : E,
						A = e.tree,
					...
					if (void 0 !== i && void 0 !== o) {
						const t = (0, f.createHrefFromUrl)(P),
							r = Date.now(),
					...
					return (0, S.navigate)(e, P, E, m, e.cache, A, a, I, N, _);
				},
				(t) => (n(t), e),
			);
		}
	...
	(e, t, r) => {
		...
		function i(e, t, r, i, o) {
			const c = (0, n.createPrefetchURL)(e);
			if (null === c) return;
			const s = (0, a.createCacheKey)(c.href, t);
	...
	(e, t, r) => {
		...
		function P(e, t, r, n, a) {
			if (a) for (const e of a) (0, i.addTransitionType)(e);
			const u = new URL((0, d.addBasePath)(e), location.href);
			...
			replace: (e, t) => {
				...
				(0, i.startTransition)(() => {
					P(
						...
						"replace",
						t?.scroll === !1
							? l.ScrollBehavior.NoScroll
							: l.ScrollBehavior.Default,
						null,
						t?.transitionTypes,
					);
				});
