(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
	...
	(e, t, r) => {
		...
		const n = e.r(53513).createRenderSearchParamsFromClient;
		("function" == typeof r.default ||
			("object" == typeof r.default && null !== r.default)) &&
			void 0 === r.default.__esModule &&
			(Object.defineProperty(r.default, "__esModule", { value: !0 }),
	...
	(e, t, r) => {
		...
		const n = e.r(9972).createRenderParamsFromClient;
		("function" == typeof r.default ||
			("object" == typeof r.default && null !== r.default)) &&
			void 0 === r.default.__esModule &&
			(Object.defineProperty(r.default, "__esModule", { value: !0 }),
	...
	(e, t, r) => {
		...
		const n = (0, e.r(61106).createAsyncLocalStorage)();
	},
	41440,
	(e, t, r) => {
		"use strict";
	...
	(e, t, r) => {
				...
				switch (n.type) {
					...
					case "validation-client":
						return (function (t, r, n) {
							var a;
							const { createExhaustiveSearchParamsProxy: o } = e.r(60297);
		...
		function v(t, r, n, a) {
			...
			if (n.validationSamples) {
				const { createExhaustiveSearchParamsProxy: a } = e.r(60297),
	...
	(e, t, r) => {
					...
					case "request":
						if (s.asyncApiPromises && s.validationSamples)
							return (function (t, r, n, a, o) {
								const { createExhaustiveParamsProxy: i } = e.r(60297),
		...
		function R(t, r, n) {
			const { createExhaustiveParamsProxy: a } = e.r(60297);
			return Promise.resolve(
				a(
					t,
	...
	(e, t, r) => {
		...
		function l({ Component: t, serverProvidedParams: r }) {
			...
			if ("u" < typeof window) {
				let r,
					a,
					{ createSearchParamsFromClient: o } = e.r(17887);
				r = o(c);
				const { createParamsFromClient: i } = e.r(87247);
				return (a = i(u)), (0, n.jsx)(t, { params: a, searchParams: r });
			}
			{
				const { createRenderSearchParamsFromClient: r } = e.r(43597),
					a = r(c),
					{ createRenderParamsFromClient: o } = e.r(48507),
					i = o(u);
	...
	(e, t, r) => {
		...
		function i({ Component: t, slots: r, serverProvidedParams: s }) {
			...
			if ("u" < typeof window) {
				const { createParamsFromClient: a } = e.r(87247),
					o = a(l);
				return (0, n.jsx)(t, { ...r, params: o });
			}
			{
				const { createRenderParamsFromClient: a } = e.r(48507),
					o = a(l);
				return (0, n.jsx)(t, { ...r, params: o });
			}
		}
