(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
	...
	(e, t, r) => {
		...
		(u.ab =
			"/ROOT/demo/nextjs/node_modules/.pnpm/next@16.2.9_react-dom@19.2.7_react@19.2.7__react@19.2.7/node_modules/next/dist/compiled/process/"),
			(t.exports = u(229));
	},
	49199,
	(e, t, r) => {
	...
	(e, t, r) => {
		...
		const u = e.r(68404),
			i = e.r(80508),
			c = "u" < typeof window ? e.r(84204).actionAsyncStorage : void 0;
	...
	(e, t, r) => {
		...
		const n = "u" < typeof window ? e.r(20212).workAsyncStorage : void 0;
		function o({ error: e }) {
			if (n) {
				const t = n.getStore();
	...
	(e, t, r) => {
		...
		function u() {
			return !(function () {
				if ("u" < typeof window) {
					const { workUnitAsyncStorage: t } = e.r(62064),
						r = t.getStore();
					if (!r) return !1;
					switch (r.type) {
						case "prerender":
