(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
	...
	{
		otherChunks: [
			"static/chunks/0kn65snj-j_yq.js",
			"static/chunks/015bqpyeecbo5.js",
			"static/chunks/1wrlgl6wns6_w.js",
			"static/chunks/040y2x05wx_xf.js",
			"static/chunks/3y9myiqma7x3m.js",
		],
		runtimeModuleIds: [93951],
	},
]),
	(() => {
		let e;
		...
		const x = Promise.resolve(void 0),
			A = new WeakMap();
		function M(t, r, n) {
			let o = e.loadChunkCached(t, n),
				l = A.get(o);
			if (void 0 === l) {
				const e = A.set.bind(A, o, x);
				(l = o.then(e).catch((e) => {
					let o;
					switch (t) {
						case i.Runtime:
