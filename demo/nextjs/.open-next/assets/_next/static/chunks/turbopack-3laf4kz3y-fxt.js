(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
	...
	{
		otherChunks: [
			"static/chunks/156cujd6gh74u.js",
			"static/chunks/19w3cytql75-w.js",
			"static/chunks/0cknmea912q33.js",
			"static/chunks/1hwpxzoo7dtr8.js",
			"static/chunks/30u6v54_h5cx3.js",
		],
		runtimeModuleIds: [66821],
	},
]),
	(() => {
		let e;
		...
		async function T(e, t, r) {
			...
			if (s.length > 0) {
				...
				for (const o of ((n = M(e, t, q(r.path))), l)) E.has(o) || E.set(o, n);
			}
			for (const e of o) _.has(e) || _.set(e, n);
			await n;
		}
		S.l = function (e) {
		...
		(S.L = function (e) {
			...
			(S.b = function (e, t, o, i) {
				const l = "SharedWorker" === e.name,
					s = [o.map((e) => q(e)).reverse(), r];
				for (const e of n) s.push(globalThis[e]);
				const u = new URL(q(t), location.origin),
					a = JSON.stringify(s);
				return (
					l
		...
		e = {
			async registerChunk(e, r) {
				const n = (function (e) {
					if ("string" == typeof e) return e;
					const r = decodeURIComponent(e.src.replace(/[?#].*$/, ""));
				...
				if ((D("string" == typeof e ? q(e) : e.src).resolve(), null != r)) {
					...
					if (
						...
						for (const e of r.runtimeModuleIds)
							!(function (e, t) {
								const r = I[t];
								if (r) {
									if (r.error) throw r.error;
