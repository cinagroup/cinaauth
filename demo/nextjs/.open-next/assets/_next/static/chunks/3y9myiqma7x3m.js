(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
	...
	(e, t, r) => {
		...
		Object.defineProperty(r, "__esModule", { value: !0 }),
			...
			e.r(53795).HTTP_ERROR_FALLBACK_ERROR_CODE,
			("function" == typeof r.default ||
				("object" == typeof r.default && null !== r.default)) &&
				void 0 === r.default.__esModule &&
				(Object.defineProperty(r.default, "__esModule", { value: !0 }),
	...
	(e, t, r) => {
		...
		const u = (n = e.r(57319)) && n.__esModule ? n : { default: n },
			c = e.r(43556),
			l = e.r(44299),
			d = e.r(53929),
			f = e.r(45133),
...
${t}`
				...
				switch (r.type) {
					...
					case "prerender": {
						...
						n &&
							n.size > 0 &&
							u.default.use(
								(0, m.makeHangingPromise)(r.renderSignal, t.route, e),
							);
						break;
					}
					case "prerender-ppr": {
  ...
  - Rerun the production build with \`next build --debug-prerender\` to generate better stack traces.`);
		...
		function es(e, t, r, n) {
			if (n.syncDynamicErrorWithStack)
				throw (
					(eo(e, n.syncDynamicErrorWithStack), new l.StaticGenBailoutError())
				);
			if (0 !== t) {
	...
	(e, t, r) => {
		...
		const n =
			"u" < typeof window
				? e.r(87461).unstable_rethrow
				: e.r(58694).unstable_rethrow;
		("function" == typeof r.default ||
			("object" == typeof r.default && null !== r.default)) &&
			void 0 === r.default.__esModule &&
			(Object.defineProperty(r.default, "__esModule", { value: !0 }),
	...
	(e, t, r) => {
		...
		const i = e.r(43148)._(e.r(57319)),
			...
			l = e.r(53866),
			d = e.r(8862),
			f = "u" < typeof window ? e.r(71423).useDynamicRouteParams : void 0,
			m = "u" < typeof window ? e.r(71423).useDynamicSearchParams : void 0,
			{
