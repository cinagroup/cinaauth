			...
			c = class extends a.Subscribable {
				...
				#g() {
					...
					if (
						...
						return;
					const t = (0, u.timeUntilStale)(this.#i.dataUpdatedAt, e);
				...
				createResult(e, t) {
					...
					let { error: b, errorUpdatedAt: R, status: g } = y;
					r = y.data;
					let Q = !1;
					...
					if (this.options.experimental_prefetchInRender) {
						const t = void 0 !== w.data,
							...
							i = () => {
								n((this.#r = w.promise = (0, o.pendingThenable)()));
							},
							a = this.#r;
						switch (a.status) {
							case "pending":
								e.queryHash === s.queryHash && n(a);
								break;
							case "fulfilled":
								(r || w.data !== a.value) && i();
								break;
							case "rejected":
								(r && w.error === a.reason) || i();
						}
					}
					return w;
				}
						...
						if (
							(m.useSyncExternalStore(
								m.useCallback(
									(e) => {
										const t = Q
											? p.subscribe(n.notifyManager.batchCalls(e))
											: u.noop;
							...
							(0, r.useLayoutEffect)(() => {
								if (a) {
									let e,
										...
										s = (e) => {
											e.target === a && (c.current = i(u.current));
										};
									return (
