(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
		...
		function n(e) {
			const o = r.forwardRef((o, t) => {
				...
				let s,
					...
					h = !1,
					v = [];
				d(b) && "function" == typeof u && (b = u(b._payload)),
					r.Children.forEach(b, (e) => {
						...
						if (
							...
							d(r) && "function" == typeof u && (r = u(r._payload)),
								(g = i(e, r)),
								v.push(g?.props?.children);
						} else v.push(e);
					}),
					g
						? (g = r.cloneElement(g, void 0, v))
				...
				return (
					g.type !== r.Fragment && (y.ref = t ? k : x), r.cloneElement(g, y)
				);
			});
			return (o.displayName = `${e}.Slot`), o;
		}
		e.s(["composeRefs", 0, t, "useComposedRefs", 0, l], 70768);
		var s = n("Slot"),
	...
	(e) => {
		...
		const i = s(
			...
			c = ({ className: e, variant: t, size: l, asChild: n = !1, ...s }) => {
				const c = n ? o.Slot : "button";
				return (0, r.jsx)(c, {
		...
		(c.displayName = "Button"),
			e.s(["Button", 0, c, "buttonVariants", 0, i], 92192);
	},
]);
