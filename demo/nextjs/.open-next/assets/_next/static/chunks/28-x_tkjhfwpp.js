(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
	...
	(e) => {
		...
		var a = e.i(37146),
			...
			m = /[\s-]/g;
		function f(e) {
			return e.toLowerCase().replace(m, " ");
		}
		var p = e.i(10584),
			h = e.i(95353),
			g = e.i(48799),
			...
			C = (e, t, r) => {
				...
				return (
					...
					(function e(t, r, n, i, a, s, o) {
						...
						for (
							var f, p, h, g, x = i.charAt(s), w = n.indexOf(x, a), v = 0;
							w >= 0;
						)
							(f = e(t, r, n, i, w + 1, s + 1, o)) > v &&
								(w === a
									? (f *= 1)
									: c.test(t.charAt(w - 1))
										? ((f *= 0.8),
											(h = t.slice(a, w - 1).match(d)) &&
												a > 0 &&
												(f *= Math.pow(0.999, h.length)))
										: u.test(t.charAt(w - 1))
											? ((f *= 0.9),
												(g = t.slice(a, w - 1).match(m)) &&
													a > 0 &&
													(f *= Math.pow(0.999, g.length)))
											: ((f *= 0.17), a > 0 && (f *= Math.pow(0.999, w - a))),
								t.charAt(w) !== r.charAt(s) && (f *= 0.9999)),
								((f < 0.1 && n.charAt(w - 1) === i.charAt(s + 1)) ||
									(i.charAt(s + 1) === i.charAt(s) &&
										n.charAt(w - 1) !== i.charAt(s))) &&
									0.1 * (p = e(t, r, n, i, w + 1, s + 2, o)) > f &&
									(f = 0.1 * p),
								f > v && (v = f),
								(w = n.indexOf(x, w + 1));
						return (o[l] = v), v;
			...
			P = s.forwardRef((e, t) => {
						...
						() => ({
							...
							setState: (e, t, n) => {
								...
								if (!Object.is(r.current[e], t)) {
									if (((r.current[e] = t), "search" === e)) $(), K(), F(1, U);
									else if ("value" === e) {
										if (
						...
						() => ({
							...
							item: (e, t) => (
								...
								() => {
									...
									F(4, () => {
										$(),
											(null == t ? void 0 : t.getAttribute("id")) === e && U(),
											A.emit();
									});
								}
							),
				...
				function K() {
					...
					W()
						...
						.forEach((e) => {
							...
							t
								? t.appendChild(
										e.parentElement === t ? e : e.closest(`${v} > *`),
									)
								: n.appendChild(
										e.parentElement === n ? e : e.closest(`${v} > *`),
									);
						}),
						t
							.sort((e, t) => t[1] - e[1])
				...
				return s.createElement(
					...
					s.createElement(
						"label",
						{ "cmdk-label": "", htmlFor: B.inputId, id: B.labelId, style: V },
						c,
					),
					q(e, (e) =>
						s.createElement(
			...
			R = s.forwardRef((e, t) => {
				...
				const u = _(i, a, [e.value, e.children, a], e.keywords),
					m = s.useContext(E),
					f = B((e) => e.value && e.value === u.current),
					p = B(
						(e) =>
							!!d ||
							!1 === l.filter() ||
				...
				if (
					(s.useEffect(() => {
						...
						if (!(!t || e.disabled))
							return (
								t.addEventListener(j, w), () => t.removeEventListener(j, w)
							);
			...
			z = s.forwardRef((e, t) => {
				...
				const f = s.useMemo(() => ({ id: o, forceMount: i }), [i]);
				return s.createElement(
					h.Primitive.div,
					{
					...
					q(e, (e) =>
						s.createElement(
							...
							s.createElement(S.Provider, { value: f }, e),
						),
					),
				);
			}),
			...
			F = s.forwardRef((e, t) => {
				...
				return s.createElement(
					...
					s.createElement(
						p.Portal,
						{ container: o },
						s.createElement(p.Overlay, { "cmdk-overlay": "", className: i }),
						s.createElement(
							p.Content,
		...
		function Q({ className: e, ...r }) {
			return (0, t.jsx)(A.Separator, {
				...
				className: (0, K.cn)("bg-border -mx-1 h-px", e),
				...r,
			});
		}
	...
	(e) => {
		...
		var t = e.i(620),
			...
			g = e.i(39304),
			x = e.i(25072),
			[w, v] = (0, l.createContextScope)("Tooltip", [u.createPopperScope]),
		...
		var E = "Tooltip",
			...
			R = (e) => {
				const {
					...
					m = C(E, e.__scopeTooltip),
					f = b(r),
					[p, h] = i.useState(null),
					x = (0, d.useId)(),
					w = i.useRef(0),
					v = l ?? m.disableHoverableContent,
					y = c ?? m.delayDuration,
					k = i.useRef(!1),
					[N, P] = (0, g.useControllableState)({
						...
						onChange: (e) => {
							e
								? (m.onOpen(), document.dispatchEvent(new CustomEvent(j)))
								: m.onClose(),
								o?.(e);
						},
						caller: E,
					...
					M = i.useCallback(() => {
						window.clearTimeout(w.current), (w.current = 0), P(!1);
					}, [P]),
					D = i.useCallback(() => {
						window.clearTimeout(w.current),
							(w.current = window.setTimeout(() => {
								(k.current = !0), P(!0), (w.current = 0);
							}, y));
					}, [y, P]);
				return (
					i.useEffect(
					...
					(0, t.jsx)(u.Root, {
						...
						children: (0, t.jsx)(S, {
							...
							onTriggerEnter: i.useCallback(() => {
								m.isOpenDelayedRef.current ? D() : z();
							}, [m.isOpenDelayedRef, D, z]),
							onTriggerLeave: i.useCallback(() => {
								v ? M() : (window.clearTimeout(w.current), (w.current = 0));
							}, [M, v]),
							onOpen: z,
							onClose: M,
		...
		var z = "TooltipTrigger",
			M = i.forwardRef((e, r) => {
				const { __scopeTooltip: n, ...a } = e,
					...
					d = b(n),
					m = i.useRef(null),
					f = (0, o.useComposedRefs)(r, m, l.onTriggerChange),
					h = i.useRef(!1),
					g = i.useRef(!1),
				...
				return (
					...
					(0, t.jsx)(u.Anchor, {
						asChild: !0,
						...d,
						children: (0, t.jsx)(p.Primitive.button, {
		...
		var T = "TooltipContent",
			...
			q = i.forwardRef((e, r) => {
				...
				return (
					i.useEffect(
						() => (
							document.addEventListener(j, p),
							() => document.removeEventListener(j, p)
						),
						[p],
					),
					i.useEffect(() => {
						if (m.trigger) {
							const e = (e) => {
								e.target instanceof Node && e.target.contains(m.trigger) && p();
							};
							return (
	...
	(e) => {
		...
		var t = e.i(92479),
			...
			p = "RovingFocusGroup",
			[h, g, x] = (0, n.createCollection)(p),
			[w, v] = (0, a.createContextScope)(p, [x]),
			[b, y] = w(p),
			j = t.forwardRef((e, t) =>
				(0, u.jsx)(h.Provider, {
					...
					(0, u.jsx)(h.ItemSlot, {
						...
						children: (0, u.jsx)(o.Primitive.span, {
							...
							onMouseDown: (0, r.composeEventHandlers)(e.onMouseDown, (e) => {
								a ? x.onItemFocus(p) : e.preventDefault();
							}),
							...
							children:
								"function" == typeof d
									? d({ isCurrentTabStop: w, hasTabStop: null != k })
									: d,
						}),
					})
				);
		...
		e.s(
			["Item", 0, N, "Root", 0, j, "createRovingFocusGroupScope", 0, v],
			39138,
		);
		const P = (0, e.i(54762).default)("circle", [
			["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
		]);
		e.s(["CircleIcon", 0, P], 15584);
	},
	59611,
	(e) => {
		"use strict";
		...
		const p = ({
			...
			return (
				...
				(0, t.jsx)(o.PresenceContext.Provider, { value: v, children: e })
			);
		};
		function h() {
			return new Map();
		...
		const v = ({
			...
			if (y !== S) {
				...
				return "wait" === d && M.length && (e = M), z(w(e)), P(y), null;
			}
			const { forceRender: D } = (0, n.useContext)(i.LayoutGroupContext);
			return (0, t.jsx)(t.Fragment, {
				children: R.map((e) => {
					const n = x(e),
						i = (!u || !!v) && (y === R || j.includes(n));
					return (0, t.jsx)(
						p,
						{
							isPresent: i,
		...
		function H({ onSuccess: e, onError: r }) {
			let i,
				...
				} = (0, O.useImagePreview)(),
				{
					...
					watch: m,
					setValue: f,
					formState: { errors: p, dirtyFields: h },
				} = (0, S.useForm)({
							...
							render: ({ field: e }) =>
								(0, t.jsxs)(z.Field, {
									children: [
										...
										(0, t.jsx)(z.FieldError, { children: p.name?.message }),
									],
								}),
						}),
						(0, t.jsx)(S.Controller, {
							...
							render: ({ field: e }) =>
								(0, t.jsxs)(z.Field, {
									children: [
										...
										(0, t.jsx)(z.FieldError, { children: p.slug?.message }),
									],
								}),
						}),
						(0, t.jsxs)(z.Field, {
		...
		function U({ onSuccess: e, onError: r }) {
			let n,
				i =
		...
		var $ = e.i(92766),
			...
			ew = { ltr: [...eh, "ArrowRight"], rtl: [...eh, "ArrowLeft"] },
			ev = { ltr: ["ArrowLeft"], rtl: ["ArrowRight"] },
			eb = "Menu",
			...
			eD = (e) => {
				const {
					...
					[d, u] = n.useState(null),
					m = n.useRef(!1),
					f = (0, em.useCallbackRef)(o),
					p = (0, er.useDirection)(s);
				return (
					n.useEffect(() => {
						const e = () => {
								(m.current = !0),
		...
		var eO = "MenuContent",
			...
			eK = (0, eu.createSlot)("MenuContent.ScrollLock"),
			eU = n.forwardRef((e, r) => {
				const {
						__scopeMenu: i,
						loop: a = !1,
					...
					[k, C] = n.useState(null),
					N = n.useRef(null),
					E = (0, Y.useComposedRefs)(r, N, w.onContentChange),
					S = n.useRef(0),
					P = n.useRef(""),
					R = n.useRef(0),
					z = n.useRef(null),
					M = n.useRef("right"),
					D = n.useRef(0),
					I = g ? ep.RemoveScroll : n.Fragment;
				...
				return (0, t.jsx)(eB, {
					...
					children: (0, t.jsx)(I, {
						...(g ? { as: eK, allowPinchZoom: !0 } : void 0),
					...
					(0, t.jsx)(ey.ItemSlot, {
						...
						children: (0, t.jsx)(ed.Item, {
							...
							children: (0, t.jsx)(ee.Primitive.div, {
								...
								onFocus: (0, X.composeEventHandlers)(e.onFocus, () => f(!0)),
								onBlur: (0, X.composeEventHandlers)(e.onBlur, () => f(!1)),
							}),
						}),
					})
				);
		...
		e5.displayName = e4;
		var e6 = "MenuItemIndicator",
			[e3, e7] = eC(e6, { checked: !1 }),
			e8 = n.forwardRef((e, r) => {
		...
		ts.displayName = ta;
		var tu = "DropdownMenu",
			[tm, tf] = (0, Z.createContextScope)(tu, [eN]),
			tp = eN(),
			[th, tg] = tm(tu),
			tx = (e) => {
				const {
		...
		function tN({ ...e }) {
			return (0, t.jsx)(tv, { "data-slot": "dropdown-menu-trigger", ...e });
		}
		...
		(tk.displayName = "DropdownMenuItem"),
			...
			(n.forwardRef((e, r) => {
				const { __scopeDropdownMenu: n, ...i } = e,
					a = tp(n);
				return (0, t.jsx)(e5, { ...a, ...i, ref: r });
			}).displayName = "DropdownMenuRadioItem"),
			(n.forwardRef((e, r) => {
				const { __scopeDropdownMenu: n, ...i } = e,
					a = tp(n);
				return (0, t.jsx)(e8, { ...a, ...i, ref: r });
			...
			[
				...
				(e) => {
					let n,
						...
						f = s || e.session,
						p = l?.members?.find((e) => e.userId === f?.user.id);
					return c
						? (0, t.jsx)(t_, {})
						: (0, t.jsxs)(G.Card, {
								children: [
															...
															(0, t.jsxs)("div", {
																...
																children: [
																	l?.members?.map((e) => {
																		const r =
																			m.isPending &&
																			m.variables?.memberIdOrEmail === e.id;
																		return (0, t.jsxs)(
																			"div",
																			{
																				className:
	...
	(e) => {
		...
		function D(e) {
			...
			return (0, t.jsx)(z, {
				scope: r,
				...v,
				children: "function" == typeof m ? m(v) : i,
			});
		}
		var I = "RadioTrigger",
		...
		var _ = ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"],
			H = "RadioGroup",
			[q, V] = (0, v.createContextScope)(H, [y.createRovingFocusGroupScope, R]),
			K = (0, y.createRovingFocusGroupScope)(),
			U = R(),
			[$, G] = q(H),
			Q = s.forwardRef((e, r) => {
				const {
		...
		var Y = s.forwardRef((e, r) => {
			const { __scopeRadioGroup: n, ...i } = e,
				...
				d = s.useRef(null),
				u = (0, w.useComposedRefs)(r, d),
				m = s.useRef(!1);
			return (
				s.useEffect(() => {
					const e = (e) => {
							_.includes(e.key) && (m.current = !0);
						},
						t = () => (m.current = !1);
					return (
	...
	(e) => {
		...
		var l,
			...
			d = e.i(75881),
			u = e.i(54762);
		const m = (0, u.default)("square-pen", [
				[
					"path",
					{
			...
			f = (0, u.default)("fingerprint-pattern", [
				[
					"path",
		...
		var j = e.i(92663),
			...
			eU = function (e, t) {
				for (var r in e)
					return (
						/^(browser|cpu|device|engine|os)$/.test(r) || (!!t && eU(e[r]))
					);
			},
			e$ = function (e) {
				return typeof e === R;
				...
				for (var r in t)
					if (typeof t[r] === P && t[r].length > 0) {
						for (var n = 0; n < t[r].length; n++)
							if (eK(t[r][n], e)) return "?" === r ? void 0 : r;
					} else if (eK(t[r], e)) return "?" === r ? void 0 : r;
				...
				device: [
					...
					[
						...
						[
							...
							{ test: /ta?b/i, ifTrue: K, ifFalse: V },
						],
						[L, "T-Mobile"],
					],
					[
					...
					(s.prototype.withClientHints = function () {
						return eH
							? eH.getHighEntropyValues(ed).then(function (t) {
									return e.setCH(new e8(t, !1)).parseCH().get();
								})
							: e.parseCH().get();
					}),
			...
			if (
				(typeof e === P
					? (eU(e, !0)
							...
							: ((r = e), (t = void 0)),
						(e = void 0))
					: typeof e !== R || eU(t, !0) || ((r = t), (t = void 0)),
				r)
			)
		...
		(e9.prototype.get = function (e) {
				...
				if (e_ && e_.userAgent == this.ua)
					switch (this.itemType) {
						case M:
							...
							break;
						case D:
							!this.get(T) && eH && eH[V] && this.set(T, V),
								"Macintosh" == this.get(H) &&
									e_ &&
									typeof e_.standalone !== z &&
									e_.maxTouchPoints &&
									e_.maxTouchPoints > 2 &&
									this.set(H, "iPad").set(T, K);
							break;
						case "os":
			...
			(e9.prototype.parseCH = function () {
				...
				switch (this.itemType) {
					...
					case "os":
						...
						if (u) {
							var m = e[J];
							u == eB && (m = parseInt(eW(m), 10) >= 13 ? "11" : "10"),
								this.set(A, u).set(O, m);
						}
						this.get(A) == eB &&
							"Xbox" == e[H] &&
			...
			(te.VERSION = "2.0.10"),
			(te.BROWSER = eV([A, O, _, T])),
			(te.CPU = eV([B])),
			(te.DEVICE = eV([H, L, T, q, V, U, K, $, G])),
			(te.ENGINE = te.OS = eV([A, O]));
		var tt = e.i(4664),
			tr = e.i(56395),
			tn = e.i(57321),
			ti = e.i(92192),
			...
			tc = e.i(30208);
		async function td(e) {
			const { data: t, error: r } = await tc.authClient.changePassword(e);
			if (r) throw Error(r.message);
			return t;
		}
		const tu = tn
		...
		function tm({ onSuccess: e, onError: t }) {
			const r = (0, tl.useMutation)({
					mutationFn: td,
					onSuccess: () => {
			...
			return (0, c.jsx)("form", {
				...
				children: (0, c.jsxs)(ts.FieldGroup, {
					children: [
						(0, c.jsx)(tr.Controller, {
							...
							render: ({ field: e }) =>
								(0, c.jsxs)(ts.Field, {
									children: [
										(0, c.jsx)(ts.FieldLabel, {
											htmlFor: "current-password",
											children: "Current Password",
										}),
										(0, c.jsx)(to.PasswordInput, {
											id: "current-password",
		...
		function tp({ onSuccess: e }) {
			const [t, r] = (0, C.useTransition)(),
				n = (0, tr.useForm)({
					resolver: (0, tt.zodResolver)(tf),
					defaultValues: { password: "" },
				});
			return (0, c.jsxs)("form", {
				onSubmit: n.handleSubmit((t) => {
					r(async () => {
						await tc.authClient.twoFactor.disable({
							password: t.password,
							fetchOptions: {
								onSuccess() {
							...
							render: ({ field: e, fieldState: t }) =>
								(0, c.jsxs)(ts.Field, {
									...
									children: [
										...
										t.invalid &&
											(0, c.jsx)(ts.FieldError, { errors: [t.error] }),
									],
								}),
						}),
					}),
		...
		const tg = function (e, t) {
			let r = e,
				...
				f = function () {
					const e = tw.getPatternPosition(r);
				...
				x = function (e, t) {
					...
					for (let o = 0; o < t.length; o += 1) {
						...
						r += l;
						const d = tw.getErrorCorrectPolynomial(c),
							u = tb(a[o], d.getLength() - 1).mod(d);
				...
				w = function (e, t, r) {
					const n = ty.getRSBlocks(e, t),
						i = tj();
					for (let t = 0; t < r.length; t += 1) {
						const n = r[t];
						i.put(n.getMode(), 4),
							i.put(n.getLength(), tw.getLengthInBits(n.getMode(), e)),
							n.write(i);
					}
					let a = 0;
			...
			(l.addData = function (e, t) {
				...
				(l.make = function () {
					if (r < 1) {
						let e = 1;
						for (; e < 40; e++) {
							const t = ty.getRSBlocks(e, n),
								r = tj();
							for (let t = 0; t < o.length; t++) {
								const n = o[t];
								r.put(n.getMode(), 4),
									r.put(n.getLength(), tw.getLengthInBits(n.getMode(), e)),
									n.write(r);
							}
							let i = 0;
							...
							d +=
								n.text || r.text
									? ' role="img" aria-labelledby="' +
										v([n.id, r.id].join(" ").trim()) +
										'"'
									: "",
							d += ">",
							d += n.text
								? '<title id="' + v(n.id) + '">' + v(n.text) + "</title>"
								: "",
							d += r.text
								? '<description id="' +
									v(r.id) +
			...
			const v = function (e) {
				...
				b = function (e) {
					...
					return s % 2 && e > 0
						? m.substring(0, m.length - s - 1) + Array(s + 1).join("▀")
			...
			return (
				(l.createASCII = function (e, t) {
					...
					let s = l.getModuleCount() * e + 2 * t,
						...
						f = "";
					for (r = 0; r < s; r += 1) {
						for (n = 0, i = Math.floor((r - o) / e), f = ""; n < s; n += 1)
							(a = 1),
								o <= n &&
									n < c &&
									o <= r &&
		...
		(tg.stringToBytes = function (e) {
			...
			(tg.createStringToBytes = function (e, t) {
				const r = (function () {
					let r = tR(e),
						n = function () {
							const e = r.read();
		...
		const tx = { L: 1, M: 0, Q: 3, H: 2 },
			tw =
				...
				(r.getErrorCorrectPolynomial = function (e) {
					let t = tb([1], 0);
					for (let r = 0; r < e; r += 1) t = t.multiply(tb([1, tv.gexp(r)], 0));
					return t;
				}),
		...
		function tD() {
			return (tD = Object.assign.bind()).apply(null, arguments);
		}
		function tI(e, t) {
			if (null == e) return {};
			var r,
		...
		var tF = [
			...
			tA = {
				bgColor: th.default.oneOfType([th.default.object, th.default.string])
					.isRequired,
				bgD: th.default.string.isRequired,
				fgColor: th.default.oneOfType([th.default.object, th.default.string])
					.isRequired,
				fgD: th.default.string.isRequired,
				size: th.default.number.isRequired,
				title: th.default.string,
				viewBoxSize: th.default.number.isRequired,
				xmlns: th.default.string,
			},
			tT = (0, C.forwardRef)(function (e, t) {
				var r = e.bgColor,
					n = e.bgD,
					i = e.fgD,
					a = e.fgColor,
		...
		(tT.displayName = "QRCodeSvg"), (tT.propTypes = tA);
		var tL = ["bgColor", "fgColor", "level", "size", "value"];
		tg.stringToBytes = function (e) {
		...
		var tO = {
				bgColor: th.default.oneOfType([th.default.object, th.default.string]),
				fgColor: th.default.oneOfType([th.default.object, th.default.string]),
				level: th.default.string,
				size: th.default.number,
				value: th.default.string.isRequired,
			},
			tB = (0, C.forwardRef)(function (e, t) {
				var r = e.bgColor,
					n = e.fgColor,
					i = e.level,
					a = e.size,
		...
		(tB.displayName = "QRCode"), (tB.propTypes = tO);
		var t_ = e.i(24322),
			tH = e.i(38901);
		const tq = tn.object({
				password: tn.string().min(8, "Password must be at least 8 characters."),
		...
		function tK({ onSuccess: e }) {
			const [t, r] = (0, C.useTransition)(),
				[n, i] = (0, C.useState)(""),
				a = (0, tr.useForm)({
					resolver: (0, tt.zodResolver)(tq),
					defaultValues: { password: "" },
				}),
				s = (0, tr.useForm)({
					resolver: (0, tt.zodResolver)(tV),
					defaultValues: { otp: "" },
				});
			return n
				? (0, c.jsxs)("div", {
						...
						children: [
							...
							(0, c.jsxs)("div", {
								...
								children: [
									...
									(0, c.jsx)(t_.default, { textToCopy: n }),
								],
							}),
							(0, c.jsxs)("form", {
								onSubmit: s.handleSubmit((t) => {
									r(async () => {
										await tc.authClient.twoFactor.verifyTotp({
											code: t.otp,
											fetchOptions: {
												onSuccess() {
				...
				: (0, c.jsxs)("form", {
						onSubmit: a.handleSubmit((e) => {
							r(async () => {
								await tc.authClient.twoFactor.enable({
									password: e.password,
									fetchOptions: {
										onSuccess(e) {
											i(e.data.totpURI);
			...
			return n
				...
				: (0, c.jsxs)("form", {
						onSubmit: a.handleSubmit((t) => {
							r(async () => {
								await tc.authClient.twoFactor.getTotpUri(
									{ password: t.password },
									{
										onSuccess(t) {
		...
		var tG = e.i(14709),
			...
			tX = e.i(11930);
		async function tY(e) {
			const { data: t, error: r } = await tc.authClient.updateUser(e);
			if (r) throw Error(r.message);
			return t;
		}
		var tZ = e.i(83682),
		...
		function t1({ currentName: e, onSuccess: t, onError: r }) {
			let n,
				i =
					((n = (0, tW.useQueryClient)()),
					(0, tl.useMutation)({
						mutationFn: tY,
						onSuccess: async () => {
							await n.invalidateQueries({ queryKey: tX.userKeys.session() }),
				...
				} = (0, tZ.useImagePreview)(),
				{
					...
					resolver: (0, tt.zodResolver)(t0),
					defaultValues: { name: "" },
				}),
				g = async (e) => {
					try {
						const n = a ? await (0, tJ.convertImageToBase64)(a) : void 0;
						i.mutate(
							...
							render: ({ field: t }) =>
								(0, c.jsxs)(ts.Field, {
									children: [
										...
										(0, c.jsx)(ts.FieldError, { children: p.name?.message }),
									],
								}),
						}),
						(0, c.jsxs)(ts.Field, {
		...
		var t2 = e.i(7642),
			...
			t7 = e.i(21252);
		async function t8(e) {
			const { data: t, error: r } = await tc.authClient.revokeSession(e);
			if (r) throw Error(r.message);
			return t;
		}
		var t9 = e.i(3196),
		...
		function rt() {
			...
			return (0, c.jsxs)(t6.Dialog, {
				open: e,
				onOpenChange: t,
				children: [
					(0, c.jsx)(t6.DialogTrigger, {
						asChild: !0,
					...
					(0, c.jsxs)(t6.DialogContent, {
						className: "sm:max-w-[425px] w-11/12",
						children: [
							(0, c.jsxs)(t6.DialogHeader, {
								children: [
									(0, c.jsx)(t6.DialogTitle, { children: "Change Password" }),
									(0, c.jsx)(t6.DialogDescription, {
										children: "Change your password",
									}),
								],
							}),
							(0, c.jsx)(tm, { onSuccess: () => t(!1) }),
						],
					}),
				],
			});
		...
		function rr() {
			const { data: e } = (0, t9.useSessionQuery)(),
				[t, r] = (0, C.useState)(!1);
			return (0, c.jsxs)(t6.Dialog, {
				open: t,
				onOpenChange: r,
				children: [
					(0, c.jsx)(t6.DialogTrigger, {
						...
						children: (0, c.jsxs)(ti.Button, {
							...
							className: "gap-2",
							variant: "default",
							children: [(0, c.jsx)(m, { size: 13 }), "Edit User"],
						}),
					}),
					(0, c.jsxs)(t6.DialogContent, {
						className: "sm:max-w-[425px] w-11/12",
						children: [
							(0, c.jsxs)(t6.DialogHeader, {
								children: [
									(0, c.jsx)(t6.DialogTitle, { children: "Edit User" }),
									(0, c.jsx)(t6.DialogDescription, {
		...
		function rn() {
			const [e, t] = (0, C.useState)(!1),
				...
				s = async () => {
					...
					a(!0);
					const e = await tc.authClient.passkey.addPasskey({ name: r });
					e?.error
						? N.toast.error(e?.error.message)
						: (t(!1),
							N.toast.success(
				...
				children: [
					...
					(0, c.jsxs)(t6.DialogContent, {
						...
						children: [
							(0, c.jsxs)(t6.DialogHeader, {
								children: [
									(0, c.jsx)(t6.DialogTitle, { children: "Add New Passkey" }),
									(0, c.jsx)(t6.DialogDescription, {
										children:
							...
							(0, c.jsx)(t6.DialogFooter, {
								children: (0, c.jsx)(ti.Button, {
									...
									children: i
										...
										: (0, c.jsxs)(c.Fragment, {
												children: [
													(0, c.jsx)(f, { className: "mr-2 h-4 w-4" }),
													"Create Passkey",
												],
											}),
								}),
		...
		function ri() {
			const { data: e } = tc.authClient.useListPasskeys(),
				[t, r] = (0, C.useState)(!1),
				[n, i] = (0, C.useState)(""),
				a = async () => {
					if (!n) return void N.toast.error("Passkey name is required");
					o(!0);
					const e = await tc.authClient.passkey.addPasskey({ name: n });
					o(!1),
						e?.error
							? N.toast.error(e?.error.message)
							: N.toast.success(
				...
				children: [
					...
					(0, c.jsxs)(t6.DialogContent, {
						...
						children: [
							(0, c.jsxs)(t6.DialogHeader, {
								children: [
									(0, c.jsx)(t6.DialogTitle, { children: "Passkeys" }),
									(0, c.jsx)(t6.DialogDescription, {
							...
							e?.length
								? (0, c.jsxs)(t7.Table, {
										children: [
											(0, c.jsx)(t7.TableHeader, {
												children: (0, c.jsx)(t7.TableRow, {
													children: (0, c.jsx)(t7.TableHead, {
														children: "Name",
													}),
												}),
											}),
											(0, c.jsx)(t7.TableBody, {
												children: e.map((e) =>
													(0, c.jsxs)(
														t7.TableRow,
														{
															...
															children: [
																...
																(0, c.jsx)(t7.TableCell, {
																	...
																	children: (0, c.jsx)("button", {
																		onClick: async () => {
																			await tc.authClient.passkey.deletePasskey(
																				{
																					id: e.id,
																					fetchOptions: {
																						onRequest: () => {
		...
		e.s(
			[
				...
				(e) => {
					let t,
						r = (0, k.useRouter)(),
						n = (0, re.useSignOutMutation)(),
						i =
							((t = (0, tW.useQueryClient)()),
							(0, tl.useMutation)({
								mutationFn: t8,
								onSuccess: () => {
									t.invalidateQueries({ queryKey: tX.userKeys.session() }),
						...
						{ data: a } = (0, t9.useSessionQuery)(),
						s = a || e.session,
						[o, l] = (0, C.useState)(!1),
						[u, m] = (0, C.useState)(!1),
						[f, x] = (0, C.useState)(!1),
						[j, E] = (0, C.useState)(e.activeSessions);
					return (0, c.jsxs)(t5.Card, {
						children: [
							(0, c.jsx)(t5.CardHeader, {
								children: (0, c.jsx)(t5.CardTitle, { children: "User" }),
							}),
							(0, c.jsxs)(t5.CardContent, {
								...
								children: [
												...
												(0, c.jsxs)("div", {
													...
													children: [
														(0, c.jsxs)(t4.Avatar, {
															...
															children: [
																(0, c.jsx)(t4.AvatarImage, {
																	src: s?.user.image || void 0,
																	alt: "Avatar",
																	className: "object-cover",
																}),
																(0, c.jsx)(t4.AvatarFallback, {
									...
									s?.user.emailVerified
										...
										: (0, c.jsxs)(t2.Alert, {
												children: [
													(0, c.jsx)(t2.AlertTitle, {
														children: "Verify Your Email Address",
													}),
													(0, c.jsxs)(t2.AlertDescription, {
														...
														children: [
															...
															(0, c.jsx)(ti.Button, {
																...
																className: "mt-2",
																onClick: async () => {
																	await tc.authClient.sendVerificationEmail(
																		{ email: s?.user.email || "" },
																		{
																			onRequest(e) {
																				x(!0);
											...
											(0, c.jsxs)("div", {
												...
												children: [
													...
													(0, c.jsxs)("div", {
														...
														children: [(0, c.jsx)(rn, {}), (0, c.jsx)(ri, {})],
													}),
												],
											}),
											(0, c.jsxs)("div", {
								...
								children: [
									...
									s?.session.impersonatedBy
										? (0, c.jsx)(ti.Button, {
												...
												onClick: async () => {
													m(!0),
														await tc.authClient.admin.stopImpersonating(),
														m(!1),
