...
1. Do not disclose the vulnerability publicly until it has been addressed by our
   team.
2. Report the vulnerability via
   [GitHub Security Advisories](https://github.com/cinagroup/cinaauth/security/advisories/new).
   Include:
...
We only support the latest version of CinaAuth.
