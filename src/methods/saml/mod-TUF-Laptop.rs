...
#[derive(Debug, Deserialize)]
#[allow(dead_code)] // SAML spec fields - may be used in future validation
...
impl SamlAuthMethod {
    ...
    #[allow(dead_code)] // Reserved for future comprehensive timestamp validation
    ...
    #[allow(dead_code)] // Reserved for future comprehensive assertion validation
    ...
    #[allow(dead_code)] // Reserved for future structured XML validation
