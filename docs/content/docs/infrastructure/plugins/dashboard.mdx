---
title: Dashboard
description: The `dash()` plugin connects your CinaAuth instance to CinaAuth Infrastructure, enabling analytics tracking, activity monitoring, and admin dashboard APIs.
---
