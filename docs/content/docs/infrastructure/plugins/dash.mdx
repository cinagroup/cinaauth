...
description: The `dash()` plugin connects your CinaAuth instance to CinaAuth Infrastructure, enabling analytics tracking, event logging, and admin dashboard APIs.
---
...
export const auth = CinaAuth({
  plugins: [
    dash({
      ...
      kvUrl: process.env.CINAAUTH_KV_URL,
