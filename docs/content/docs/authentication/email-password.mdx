...
description: Implementing email and password authentication with CinaAuth.
---

Email and password authentication is a common method used by many applications. CinaAuth provides a built-in email and password authenticator that you can easily integrate into your project.
