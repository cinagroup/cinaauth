...
description: CinaAuth Next.js example.
---

This is an example of how to use CinaAuth with Next.
...
See the [account portal](https://accounts.cinaseek.ai)

<ForkButton url="cinagroup/cinaauth/tree/main/apps/account-portal" />

<iframe
  src="https://stackblitz.com/github/cinagroup/cinaauth/tree/main/apps/account-portal?codemirror=1&fontsize=14&hidenavigation=1&runonclick=1&hidedevtools=1"
  style={{
width: "100%",
height: "500px",
border: 0,
...
overflow: "hidden"
  ...
  title="CinaAuth Next.js Example"
