...
<Steps>
  <Step>
    ...
    To get started, check out our [installation](/docs/installation) guide for setting up CinaAuth on your server. If you prefer, check out the [full example](https://github.com/cinaauth/examples/tree/main/expo-example).
