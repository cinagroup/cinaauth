...
If you discover a security vulnerability in CinaAuth, please report it to us at [security@cinagroup.com](mailto:security@cinagroup.com). We address all reports promptly, and credits will be given for validated discoveries.
