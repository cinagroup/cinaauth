---
title: OIDC Provider
description: Open ID Connect plugin for CinaAuth that allows you to have your own OIDC provider.
---
...
<Callout type="warn">
  This plugin is in active development and may not be suitable for production use. Please report any issues or bugs on [GitHub](https://github.com/cinagroup/cinaauth).
</Callout>
...
<Steps>
  <Step>
    ...
    import { oidcProvider } from "cinaauth/plugins"; // [!code highlight]
  ...
  <Step>
    ...
    import { oidcClient } from "cinaauth/client/plugins" // [!code highlight]
