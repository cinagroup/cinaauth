---
title: Dub
description: CinaAuth Plugin for Lead Tracking using Dub links and OAuth Linking
---
...
<Steps>
  ...
  <Step>
    ...
    import { dubAnalytics } from "@dub/cinaauth"
    import { dub } from "dub"
...
import { dubAnalyticsClient } from "@dub/cinaauth/client";
