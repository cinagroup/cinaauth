...
description: CinaAuth Plugin for Autumn Billing
---
...
<Steps>
  ...
  <Step>
    ...
    <Tabs items={["User", "Organization", "User & Organization", "Custom"]}>
      <Tab value="User">
        ```ts title="auth.ts"
        import { autumn } from "autumn-js/cinaauth";
  ...
  <Step>
    ...
    In your layout file, wrap your application with the AutumnProvider component, and pass in the `useCinaAuth` to true.
    ...
    export default function RootLayout({
      ...
      return (
        <html>
          <body>
            <AutumnProvider useCinaAuth={true}>
              {children}
            </AutumnProvider>
          </body>
        </html>
