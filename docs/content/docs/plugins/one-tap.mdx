---
title: One Tap
description: One Tap plugin for CinaAuth
---
...
<Steps>
  <Step>
    ...
    import { oneTap } from "cinaauth/plugins"; // [!code highlight]
  ...
  <Step>
    ...
    import { oneTapClient } from "cinaauth/client/plugins"; // [!code highlight]
