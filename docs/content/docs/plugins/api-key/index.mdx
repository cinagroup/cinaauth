---
title: API Key
description: API Key plugin for CinaAuth.
---
...
<Steps>
  ...
  <Step>
    ...
    import { apiKey } from "@cinaauth/api-key" // [!code highlight]
  ...
  <Step>
    ...
    import { apiKeyClient } from "@cinaauth/api-key/client"  // [!code highlight]
