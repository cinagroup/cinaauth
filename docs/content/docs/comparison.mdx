---
title: Comparison
description: Comparison of CinaAuth versus other auth libraries and services.
---

> <p className="text-orange-400 dark:text-orange-200">Comparison is the thief of joy.</p>

Here are some key reasons why you may want to use CinaAuth instead of other auth libraries and services.
