---
title: Comparison
description: Comparison of CinaAuth versus over other auth libraries and services.
---

> <p className="text-orange-400 dark:text-orange-200">Comparison is the thief of joy.</p>

Here are non detailed reasons why you may want to use CinaAuth over other auth libraries and services.
