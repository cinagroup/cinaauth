...
To use the Prisma adapter, you need to install the `@cinaauth/prisma-adapter` package:
...
* [How to use Prisma ORM with CinaAuth and Next.js](https://www.prisma.io/docs/guides/CinaAuth-nextjs)
