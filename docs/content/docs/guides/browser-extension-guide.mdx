...
If you would like to view a completed example, you can check out the <Link href="https://github.com/cinaauth/examples/tree/main/browser-extension-example">browser extension example</Link>.
