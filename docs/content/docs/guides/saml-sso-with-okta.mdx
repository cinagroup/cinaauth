...
5. Configure the following settings:
   ...
   * **Single Sign-on URL**: Your CinaAuth callback endpoint (e.g., `http://localhost:3000/api/auth/sso/saml2/callback/sso`). Note: `sso` is your `providerId`
...
<Callout type="info">
  **IdP-Initiated SSO**: If you want users to access your app from the Okta dashboard, make sure the **Single Sign-on URL** points to the callback endpoint (`/api/auth/sso/saml2/callback/{providerId}`). CinaAuth automatically handles both SP-initiated and IdP-initiated flows.
</Callout>
