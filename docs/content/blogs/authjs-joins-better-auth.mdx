---
title: Auth.js is now part of CinaAuth
description: "Auth.js, formerly known as NextAuth.js, is now being maintained and overseen by CinaAuth team"
date: 2025-09-22
author:
  name: "CinaAuth Team"
...
That shared frustration and the vision of empowering everyone to truly own their auth started the creation of CinaAuth. Since our goals aligned with the Auth.js team, we were excited to help maintain Auth.js and make auth better across the web. As we talked more, we realized that CinaAuth was the best home for Auth.js.
...
But we strongly recommend new projects to start with CinaAuth unless there are some very specific feature gaps (most notably stateless session management without a database). Our roadmap includes bringing those capabilities into CinaAuth, so the ecosystem can converge rather than fragment.
...
CinaAuth beginning was inspired by Auth.js, and now, together, the two projects can carry the ecosystem further. The end goal remains unchanged: you should own your auth!
...
<Cards>
  ...
  <Card href="https://www.cinagroup.com/docs/comparison" title="Comparison">
    Comparison between CinaAuth and other options
  </Card>

  <Card href="https://www.cinagroup.com/docs/guides/next-auth-migration-guide" title="NextAuth Migration Guide">
    Migrate from NextAuth to CinaAuth
  </Card>

  <Card href="https://www.cinagroup.com/docs/guides/clerk-migration-guide" title="Clerk Migration Guide">
    Migrate from Clerk to CinaAuth
  </Card>
</Cards>
