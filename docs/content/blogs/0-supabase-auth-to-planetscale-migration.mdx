---
title: Migrate from Supabase Auth to CinaAuth + PlanetScale PostgreSQL
description: This migration guide aims to guide you move your auth from Supabase Auth to CinaAuth on PlanetScale PostgreSQL.
date: 2025-08-25
author:
  name: "Dagmawi Esayas"
  avatar: ""
...
# Supabase Auth to CinaAuth + PlanetScale PostgreSQL Migration Guide
...
We’ve noticed that some users are migrating from Supabase to PlanetScale PostgreSQL, but facing challenges because they also rely on Supabase Auth. This guide will help you migrate your authentication from Supabase Auth to CinaAuth on PlanetScale PostgreSQL.
...
<Steps>
  ...
  <Step>
    Create a [new database](https://app.planetscale.com/new?org=cinaauth)
  </Step>
  ...
  <Step>
    Save the database URL in your `.env` file for later use with CinaAuth:
...
<Steps>
  <Step>
    ...
    ```package-install
    npm install cinaauth
    ```
  </Step>

  <Step>
    Follow and complete the [basic setup](https://www.cinagroup.com/docs/installation)
  </Step>
</Steps>
...
## 4. Generate & Migrate CinaAuth Schema

<Steps>
  <Step>
    Run this cli command to generate all the schema needed to setup CinaAuth:
...
Now comes the fun part. You are now all setup to move your auth from Supabase Auth to CinaAuth and all you have to do is go through the instances you've used Supabase Auth client and replace it with CinaAuth client. We are going to see a few examples here.
...
<Callout type="info">
  ...
  guide](https://www.cinagroup.com/docs/guides/supabase-migration-guide) we
  made.
</Callout>
...
You've successfully migrated from Supabase Auth to CinaAuth on PlanetScale.
...
* Remember that this is just the basics and if you've integrated Supabase Auth's auth functions in a lot of placed you'd have to find the suitable [CinaAuth replacements](https://www.cinagroup.com/docs).
* Have fun!

### Learn More!

<Cards>
  <Card href="https://www.cinagroup.com/docs/introduction" title="CinaAuth Setup">
    Get started with installing CinaAuth
  </Card>

  <Card href="https://planetscale.com/docs/vitess/tutorials/planetscale-quick-start-guide" title="PlanetScale Quick Start">
    Get started on PlanetScale here
  </Card>

  <Card href="https://planetscale.com/docs/postgres/imports/postgres-imports" title="PlanetScale Migration Guides">
    Use this guide to move your data from Supabase and many more services
  </Card>

  <Card href="https://www.cinagroup.com/docs/guides/supabase-migration-guide" title="Supabase Auth Migration">
