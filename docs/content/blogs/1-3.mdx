...
## CinaAuth 1.3 Release

We're excited to announce the release of CinaAuth 1.3. This release includes a lot of new features and improvements.

To upgrade, run:

```package-install
npm install cinaauth@1.3
```
...
```ts title="auth.ts"
import { mcp } from "cinaauth/plugins";
...
👉 [Check the full changelog](https://github.com/cinagroup/cinaauth/releases/tag/v1.3.0)
