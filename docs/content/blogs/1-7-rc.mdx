...
| ---------------------------------------------- | ---------------------------------------------------------------------------------------------------- |
| Basic CinaAuth setup                           | Usually just the `@rc` install and any generated schema changes                                      |
...
| `@cinaauth/oauth-provider`                     | The largest set of changes: resources, DPoP, back-channel logout, `max_age`, and safer OAuth checks  |
| MCP                                            | A package move to `@cinaauth/mcp`, new imports, new endpoint paths, and a schema migration           |
